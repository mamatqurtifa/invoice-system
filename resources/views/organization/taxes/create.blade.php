<x-organization-layout>
    ...
    <x-card class="max-w-3xl mx-auto">
        <form action="{{ route('organization.taxes.store') }}" method="POST">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div class="border-t border-gray-200 pt-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <x-form.checkbox
                            ...
                            value="1"
                            label="Make this tax rate active immediately"
                        />
                ...
                <div class="flex justify-end space-x-3 border-t border-gray-200 pt-6">
                    <x-button 
                        href="{{ route('organization.taxes.index') }}" 
                        variant="secondary"
                    >
                        Cancel
                    </x-button>
