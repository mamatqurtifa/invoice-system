<x-admin-layout>
    ...
    <div class="mb-6">
        <h2 class="text-2xl font-bold text-gray-900">Edit Courier</h2>
        <p class="mt-1 text-sm text-gray-600">Update information for {{ $courier->name }}</p>
    </div>
            ...
            <div class="p-6 space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $courier->name) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-sky-500 focus:ring-sky-500 sm:text-sm" required>
                        @error('name')
                    ...
                    <div>
                        ...
                        <input type="text" name="code" id="code" value="{{ old('code', $courier->code) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-sky-500 focus:ring-sky-500 sm:text-sm" required placeholder="e.g., JNE, DHL, USPS">
                        @error('code')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="tracking_url" id="tracking_url" value="{{ old('tracking_url', $courier->tracking_url) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-sky-500 focus:ring-sky-500 sm:text-sm" placeholder="https://example.com/track?number={tracking_number}">
                        @error('tracking_url')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="url" name="website" id="website" value="{{ old('website', $courier->website) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-sky-500 focus:ring-sky-500 sm:text-sm">
                        @error('website')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1 flex items-center">
                            @if($courier->logo)
                                <div class="mr-3">
                                    <img src="{{ Storage::url($courier->logo) }}" alt="{{ $courier->name }}" class="h-12 w-12 object-cover rounded">
                                </div>
                            @endif
                    ...
                    <div>
                        ...
                        <input type="text" name="contact_number" id="contact_number" value="{{ old('contact_number', $courier->contact_number) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-sky-500 focus:ring-sky-500 sm:text-sm">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" id="description" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-sky-500 focus:ring-sky-500 sm:text-sm">{{ old('description', $courier->description) }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
